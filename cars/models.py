...
class CarsList(models.Model):
    ...
    photo_main = models.ImageField(upload_to ='photo/%Y/%m/%b', blank=True)
    photo_1= models.ImageField(upload_to ='photo/%Y/%m/%b', blank=True)
    photo_2 = models.ImageField(upload_to ='photo/%Y/%m/%b', blank=True)
    photo_3 = models.ImageField(upload_to ='photo/%Y/%m/%b', blank=True)
